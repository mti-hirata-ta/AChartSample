...
namespace AChartEngine.Chart {
	...
	[global::Android.Runtime.Register ("org/achartengine/chart/ScatterChart", DoNotGenerateAcw=true)]
	public partial class ScatterChart : global::AChartEngine.Chart.XYChart {


		[Register ("TYPE")]
		public const string Type = (string) "Scatter";
		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/achartengine/chart/ScatterChart", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ScatterChart); }
		}
		...
		public ScatterChart (global::AChartEngine.Model.XYMultipleSeriesDataset p0, global::AChartEngine.Renderer.XYMultipleSeriesRenderer p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (ScatterChart)) {
...
#pragma warning disable 0169
		...
		{
			global::AChartEngine.Chart.ScatterChart __this = global::Java.Lang.Object.GetObject<global::AChartEngine.Chart.ScatterChart> (native__this, JniHandleOwnership.DoNotTransfer);
