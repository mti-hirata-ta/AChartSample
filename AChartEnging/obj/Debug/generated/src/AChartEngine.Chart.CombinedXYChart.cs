...
namespace AChartEngine.Chart {
	...
	[global::Android.Runtime.Register ("org/achartengine/chart/CombinedXYChart", DoNotGenerateAcw=true)]
	public partial class CombinedXYChart : global::AChartEngine.Chart.XYChart {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/achartengine/chart/CombinedXYChart", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CombinedXYChart); }
		}

		protected CombinedXYChart (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lorg_achartengine_model_XYMultipleSeriesDataset_Lorg_achartengine_renderer_XYMultipleSeriesRenderer_arrayLjava_lang_String_;
		[Register (".ctor", "(Lorg/achartengine/model/XYMultipleSeriesDataset;Lorg/achartengine/renderer/XYMultipleSeriesRenderer;[Ljava/lang/String;)V", "")]
		public CombinedXYChart (global::AChartEngine.Model.XYMultipleSeriesDataset p0, global::AChartEngine.Renderer.XYMultipleSeriesRenderer p1, string[] p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			if (GetType () != typeof (CombinedXYChart)) {
				SetHandle (global::Android.Runtime.JNIEnv.CreateInstance (GetType (), "(Lorg/achartengine/model/XYMultipleSeriesDataset;Lorg/achartengine/renderer/XYMultipleSeriesRenderer;[Ljava/lang/String;)V", new JValue (p0), new JValue (p1), new JValue (native_p2)), JniHandleOwnership.TransferLocalRef);
				if (p2 != null) {
			...
			SetHandle (JNIEnv.NewObject (class_ref, id_ctor_Lorg_achartengine_model_XYMultipleSeriesDataset_Lorg_achartengine_renderer_XYMultipleSeriesRenderer_arrayLjava_lang_String_, new JValue (p0), new JValue (p1), new JValue (native_p2)), JniHandleOwnership.TransferLocalRef);
			if (p2 != null) {
				JNIEnv.CopyArray (native_p2, p2);
				JNIEnv.DeleteLocalRef (native_p2);
			}
...
#pragma warning disable 0169
		...
		{
			global::AChartEngine.Chart.CombinedXYChart __this = global::Java.Lang.Object.GetObject<global::AChartEngine.Chart.CombinedXYChart> (native__this, JniHandleOwnership.DoNotTransfer);
