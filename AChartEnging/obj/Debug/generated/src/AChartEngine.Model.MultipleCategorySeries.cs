...
#pragma warning disable 0169
		...
		{
			global::AChartEngine.Model.MultipleCategorySeries __this = global::Java.Lang.Object.GetObject<global::AChartEngine.Model.MultipleCategorySeries> (native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual global::AChartEngine.Model.XYSeries ToXYSeries ()
		{
			if (id_toXYSeries == IntPtr.Zero)
				id_toXYSeries = JNIEnv.GetMethodID (class_ref, "toXYSeries", "()Lorg/achartengine/model/XYSeries;");

			if (GetType () == ThresholdType)
				return global::Java.Lang.Object.GetObject<global::AChartEngine.Model.XYSeries> (JNIEnv.CallObjectMethod  (Handle, id_toXYSeries), JniHandleOwnership.TransferLocalRef);
			else
				return global::Java.Lang.Object.GetObject<global::AChartEngine.Model.XYSeries> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, id_toXYSeries), JniHandleOwnership.TransferLocalRef);
		}
